...
",
        ...
        public void BaseType_is_stored_in_snapshot()
        {
            Test(
                builder =>
                    {
                        builder.Entity<DerivedEntity>(b =>
                            {
                                b.BaseType(typeof(BaseEntity));
                            });
                    },
                @"
...
builder.Entity(""Microsoft.Data.Entity.Commands.Migrations.ModelSnapshotTest+DerivedEntity"").BaseType(""Microsoft.Data.Entity.Commands.Migrations.ModelSnapshotTest+BaseEntity"");
",
                o =>
                {
                    Assert.Equal(2, o.EntityTypes.Count());

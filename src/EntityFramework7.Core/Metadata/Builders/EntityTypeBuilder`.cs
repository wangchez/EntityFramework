...
namespace Microsoft.Data.Entity.Metadata.Builders
{
        ...
        where TEntity : class
    {
        ...
        {
            return (EntityTypeBuilder<TEntity>)base.Annotation(annotation, value);
        }

        public new virtual EntityTypeBuilder<TEntity> BaseType([NotNull] string name)
        {
            return (EntityTypeBuilder<TEntity>)base.BaseType(name);
        }

        public new virtual EntityTypeBuilder<TEntity> BaseType([NotNull] Type entityType)
        {
            return (EntityTypeBuilder<TEntity>)base.BaseType(entityType);
        }

        public virtual EntityTypeBuilder<TEntity> BaseType<TBaseType>()
        {
            return (EntityTypeBuilder<TEntity>)base.BaseType(typeof(TBaseType));
        }
